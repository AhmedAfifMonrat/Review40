...
WHERE $table_name.name='$query_name';
";
$result=mysql_query($sql,$con);
   echo "<table border='1' width='1000px' style='border-collapse:collapse;text-align:center;'";
           ...
           while($row = mysql_fetch_array($result)) {
			...
			<button id="delete" onClick="load_delete_aff_info(this.value)" style="width:100px; background:#FF0000; height:30px; cursor:pointer; color:#ffffff; margin-top:30px; margin-left:15px;font-weight:bold" value="<?php echo $query_name;  ?>">DELETE</button>
