...
<link rel="stylesheet" type="text/css" href="css/flight_review.css" />
...
<div id="flight_wrapper">
 <div id="header">
  ...
  <div id="flight_review_form">
  <form>
  <p style="font-size:18px; padding-bottom:5px">Title of your review</p>
  <input type="text" id="title_review_flight" name="title_review_flight" style="height:30px; width:624px; border:1px solid #CCCCCC; margin-bottom:15px;" />
  <p style="font-size:18px; padding-bottom:5px">Your Review</p>
  <textarea name="flight_review" id="flight_review" cols="45" rows="5" style="height:146px; width:624px;margin-bottom:10px;"></textarea>
  ...
  I certify that this review is based on my own experience and my genuine opinion of this flight,and that I have no personal and business relationship with this </p>
