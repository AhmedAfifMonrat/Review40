...
$('#star').load('ratings/star.html');
alert(a);

}
else if(a==2)
{
$('#star').load('ratings/star2.html');
alert(a);
}
else if(a==3)
{
$('#star').load('ratings/star3.html');
alert(a);
}
else if(a==4)
{
$('#star').load('ratings/star4.html');
alert(a);
}
else if(a==5)
{
$('#star').load('star5.html');
alert(a);
}
}
...
<div id="hotel_wrapper">
 <div id="header">
   <div class="logo"></div>
      ...
      <ul class="menu">
                        ...
                        <li><a href="review_card.php" style="padding-left:20px;">Review40 card</a></li>
 ...
 $web=$row['website'];
  ...
  ?>
  <div id="hotel_pic"><?php echo "<img src=\"$t_img\" height=\"100\" width=\"100\" />"; ?></div>
  <div id="hotel_title">
  ...
  <div id="hotel_review_form">
  <form action="hotel_review.php" method="post" name="form">
  <p style="font-size:18px; padding-bottom:5px">Title of your review</p>
  <input type="text" id="title_review_hotel" name="title_review_hotel" style="height:30px; width:624px; border:1px solid #CCCCCC; margin-bottom:15px;" />
  <p style="font-size:18px; padding-bottom:5px">Your Review</p>
  <textarea name="hotel_review" id="hotel_review" cols="45" rows="5" style="height:146px; width:624px;margin-bottom:10px;"></textarea>
  ...
  <label>
  <input type="button" name="button" id="button2" value="Couples" style="height:58px; width:99px" />
  </label>
  <label>
  <input type="button" name="button" id="button3" value="Family" style="height:58px; width:99px" />
  </label>
  <label>
  <input type="button" name="button" id="button4" value="Friends" style="height:58px; width:99px"/>
  </label>
  <label>
  <input type="button" name="button" id="button5" value="Solo" style="height:58px; width:99px" />
  </label>
  ...
  <li><a title='Rate this 1 star out of 5' class='one-star' onclick='send(1)'>1</a></li>
  <li><a title='Rate this 2 stars out of 5' class='two-stars' onclick='send(2)'>2</a></li>
  <li><a title='Rate this 3 stars out of 5' class='three-stars' onclick='send(3)'>3</a></li>
  <li><a title='Rate this 4 stars out of 5' class='four-stars' onclick='send(4)'>4</a></li>
  <li><a title='Rate this 5 stars out of 5' class='five-stars' onclick='send(5)'>5</a></li>
       </ul>
        </td>
        <td width="177">Value</td>
      </tr>
      <tr>
        <td>
  ...
  I certify that this review is based on my own experience and my genuine opinion of this hotel,and that I have no personal and business relationship with this </p><p style="font-size:14px;margin-left:30px">establishment,and have not been offered any incentive or payment originating from the establishment to write this review.I understand that Review40 has a zero-tolerance policy on fake reviews.</p>
 ...
 mysql_select_db($database,$con);
  ...
  $date=$_POST['date'];
  $name=$_POST['hotel'];
  $sqe="insert into $table_name1(review_item,review_title,review,travel_date) VALUES('$name','$title','$review','$date')";
  mysql_query($sqe);
  echo "<script type='text/javascript'>document.getElementById('hotel_name').innerHTML='';
  document.getElementById('hotel_review_form').innerHTML='';
  document.getElementById('hotel_name').innerHTML='Your Review is successfully Added';
  </script>"
  ;
  }
  ?>
