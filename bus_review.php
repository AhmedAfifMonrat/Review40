...
<link rel="stylesheet" type="text/css" href="css/bus_review.css" />
...
<div id="bus_wrapper">
 <div id="header">
  ...
  <div id="bus_review_form">
  <form>
  <p style="font-size:18px; padding-bottom:5px">Title of your review</p>
  <input type="text" id="title_review_bus" name="title_review_bus" style="height:30px; width:624px; border:1px solid #CCCCCC; margin-bottom:15px;" />
  <p style="font-size:18px; padding-bottom:5px">Your Review</p>
  <textarea name="bus_review" id="bus_review" cols="45" rows="5" style="height:146px; width:624px;margin-bottom:10px;"></textarea>
  ...
  I certify that this review is based on my own experience and my genuine opinion of this bus,and that I have no personal and business relationship with this </p>
