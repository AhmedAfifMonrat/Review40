...
<form id="basic_info" action="adminpanel.php" method="post" enctype="multipart/form-data">
  <table width="auto" border="0">
    <tr>
      <td height="40"><label>Hotel Name</label></td>
      <td><input name="h_name" type="text" id="h_name" size="40" required="required" style="height:25px">
          <span id="hname_validate" style="color:#FF3300"></span> 
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="40"><label>Hotel Details</label></td>
     ...
     <tr>
      <td height="45"><label>Google Map(Hotel)</label></td>
    ...
    <tr><td><input type="submit" onClick="" value="Save" name="send_hotel_info" style="background-color:#FF0000;cursor: pointer; width: 100px;color: white;height: 25px;"/></td></tr>
  </table>
</form>
</div>
</body>
